<template>
  ...
  >
    <div class="brand"><span>行云</span></div>
    <hr />

    <!-- Sidebar Navigation Menu -->
    <a-menu theme="light" mode="inline">
      <a-menu-item class="menu-item-header"> 工作流 </a-menu-item>
      <a-menu-item>
        <router-link to="/dashboard">
          ...
          <span class="label">工作流列表</span>
        </router-link>
      </a-menu-item>
      <a-menu-item>
        <router-link to="/createFlow">
          <span class="icon">
            <svg
              width="20"
              height="20"
      ...
      <a-menu-item class="menu-item-header"> 我 </a-menu-item>
      <a-menu-item>
    ...
    <div class="aside-footer">
      <div class="footer-box">
        ...
        <a-button
          type="primary"
          href="https://www.bilibili.com/video/BV1tQ4y1B7PU?share_source=copy_web"
          block
          target="_blank"
        >
          好
